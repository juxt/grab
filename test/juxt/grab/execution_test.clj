...
(deftest credo-test
  (let [schema (schema/compile-schema
    ...
    (is (=
         {:questionnaire
             {"title" "Financial goals and reasons for investing",
              "description"
              "Goal for investing can also include your personal values",
              "id" "1"},
             :questions
             [{"title" "Approach to sustaninable investing",
               "questionType" "SINGLE_CHOICE",
               "description"
               "Which of the following best describe your investiment preference?"}
              {"title" "Allocation style",
               "questionType" "SINGLE_CHOICE",
               "description" "Preference of sustainable investiments"}],
             :answers
